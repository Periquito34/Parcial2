...
public class OrchestratorController {
    ...
    public OrchestratorController(WebClient.Builder webClientBuilder) {
    ...
    private Mono<String> fallbackService1(String requestBody, Throwable throwable) {
        logger.error("Service 1 Circuit is open: " + throwable.getMessage(), throwable);
